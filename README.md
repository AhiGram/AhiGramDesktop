...
- **Slowdown Bypass** — traffic can be routed through a WebSocket tunnel without requiring manual configuration (based on [tg-ws-proxy](https://github.com/nicktindall/cyclon.p2p-rtc-server)).
