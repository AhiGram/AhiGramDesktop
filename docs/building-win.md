...
> [!IMPORTANT]
> All commands must be executed from the **x86 Native Tools Command Prompt for VS 2022.bat** (found in **Start Menu > Visual Studio 2022**). Using a standard Command Prompt or PowerShell will cause the build to fail.
...
* **Python 3.10**: Download from [python.org](https://www.python.org/downloads/) and ensure "Add to PATH" is checked.
* **Git**: Download and install from [git-scm.com](https://git-scm.com/download/win).

## Clone source code and prepare libraries

Open the **x86 Native Tools Command Prompt**, navigate to your ***BuildPath*** and run:
...
Navigate to ***BuildPath*\AhiGramDesktop\Telegram** and run the configuration script:
...
3. Go to **Build > Build Telegram** (available for Debug and Release).
